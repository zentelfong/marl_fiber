...
#if defined(__i386__) && !defined(MARL_USE_UCONTEXT)
...
MARL_EXPORT
void marl_fiber_init(struct marl_fiber_context *ctx, void *stack,
                     uint32_t stack_size, void (*target)(void *), void *arg) {
